...
public class SnaiperRifle : MonoBehaviour
{
...

    {
		...
		GameObject.FindWithTag ("MainCamera").GetComponent<MouseLook>().sensitivityX=3;//sensitivity change
    }
    ...
    public void AimOff()
    {
		...
		GameObject.FindWithTag ("MainCamera").GetComponent<MouseLook>().sensitivityX=15;//sensitivity change
    }
